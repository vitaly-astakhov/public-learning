...
Кэш считает сохраненный ответ «свежим», если он может быть повторно использован без "валидации" ([**validation** 📂](./validators.md))
...
Кеш должен сохранять все поля заголовков (**header fields**), полученные вместе с ответом, при сохранении ответа. Но есть [исключения из правил](https://www.rfc-editor.org/rfc/rfc9111#section-3.1-1)
