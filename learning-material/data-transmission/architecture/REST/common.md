...
- **intermediaries** - Промежуточные компоненты действуют как клиент (**client**), так и сервер (**server**) для пересылки запросов и ответов с возможным переводом. - [**Intermediaries [HTTP Semantics]**](https://www.rfc-editor.org/rfc/rfc9110#section-3.7), [**HTTP Intermediaries 📂**](../../http/concepts/intermediaries.md)
...
- **user agent** - Пользовательский агент (**user agent**) использует клиентский соединитель (**client connector**) для инициирования запроса и становится конечным получателем ответа. - [**User Agents [HTTP Semantics]**](https://www.rfc-editor.org/rfc/rfc9110#section-3.5), [**HTTP User Agent 📂**](../../http/concepts/user-agent.md)
